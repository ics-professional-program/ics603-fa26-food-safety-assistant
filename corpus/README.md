...
| `sop/` | **Fictional** Pacific Market Cafe standard operating procedures | curated |
...
publication; Hawaii Administrative Rules are public state rules.
...
| `sop/` | Fictional; written for the course | — |
...
3. **SOP stricter than code** — Pacific Market Cafe holds hot food at 140°F
   where the code requires 135°F (`sop/hot-holding-line-checks.md`); the
   SOP's 48-hour illness return rule is also stricter than the code's 24
   hours (`sop/employee-illness.md`).
